...
class Main(http.Controller):
    ...
    @http.route("/l10n_co_e_invoice/accept_dian_invoice", type='http', auth='none', csrf=False)
    ...
    @http.route("/l10n_co_e_invoice/reject_dian_invoice", type='http', auth='none', csrf=False)
    def reject_dian_invoice(self, dian_document):
        ...
        if rec_dian_document.date_email_acknowledgment:
            ...
            <html>
                <body>
                    <form action="/l10n_co_e_invoice/reject_dian_invoice_reason">
                        <table>
    ...
    @http.route("/l10n_co_e_invoice/reject_dian_invoice_reason", type='http', auth='none', csrf=False)
