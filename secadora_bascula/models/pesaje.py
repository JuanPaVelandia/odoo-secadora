...
class SecadoraPesajeStock(models.Model):
    ...
    def _crear_picking_inventario(self):
        ...
        picking_vals = {
            ...
            'move_ids': [(0, 0, {
                'description_picking': f'{self.producto_id.name} - {self.name}',
    ...
    def _crear_picking_servicio(self):
        ...
        picking_vals = {
            ...
            'location_dest_id': picking_type.default_location_dest_id.id,
            'move_ids': [(0, 0, {
                'description_picking': f'{producto.name} - {self.name}',
    ...
    def _crear_picking_salida_bultos(self):
        ...
        picking_vals = {
            ...
            'location_dest_id': picking_type.default_location_dest_id.id,
            'move_ids': [(0, 0, {
                'description_picking': f'{producto.name} - {self.name} (bultos)',
                'product_id': producto.id,
    ...
    def _crear_transformacion_venta(self):
        ...
        move_vals.append({
            'description_picking': f'Consumo Verde - {self.name}',
            'product_id': producto_verde.id,
        ...
        move_vals.append({
            'description_picking': f'Produccion Seco - {self.name}',
        ...
        if merma > 0:
            move_vals.append({
                'description_picking': f'Merma Secado - {self.name}',
                'product_id': producto_verde.id,
