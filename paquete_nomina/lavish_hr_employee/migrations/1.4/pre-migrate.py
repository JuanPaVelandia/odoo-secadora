...
def migrate(cr, version):
    ...
    _logger.info("Ejecutando pre-migración lavish_hr_employee 1.4")
    ...
    if result and result[0] == 'character varying':
        _logger.info("Columna validated_certificate es varchar, limpiando para conversión")
        # Eliminar la columna vieja, Odoo la recreará correctamente
        cr.execute("""
