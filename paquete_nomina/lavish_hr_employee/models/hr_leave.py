...
# -------------------------------------------------------------------------
# Importar constantes globales desde hr_slip_constante
# -------------------------------------------------------------------------
try:
    ...
    # Fallback si el modulo no esta instalado
    NOVELTY_TYPE_SELECTION = [
...
class HrLeaveType(models.Model):
    ...
    liquidacion_value = fields.Selection(
        ...
        help='BASE PARA LIQUIDAR VALOR DE LA AUSENCIA\n'
             ...
             '  + YEAR ... Usa promedio del ano anterior\n'
