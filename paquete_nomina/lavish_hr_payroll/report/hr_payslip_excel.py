# -*- coding: utf-8 -*-
"""
Módulo de exportación Excel para valores base y acumulados
===========================================================

Extensión de hr.payslip para generar reportes Excel de:
- Valores base (vacaciones, prima, cesantías)
...
class HrPayslipExcel(models.Model):
    _inherit = 'hr.payslip'
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # CONSULTAS SQL PARA ACUMULADOS
    # ══════════════════════════════════════════════════════════════════════════

    def get_query(self, process, date_start, date_end):
        """
        Genera la consulta SQL para obtener los acumulados de nómina.

        Args:
            process: Tipo de proceso (base_vacaciones, base_prima, base_cesantias)
            date_start: Fecha de inicio del período
            date_end: Fecha de fin del período
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # EXPORTACION EXCEL VALORES BASE (ACUMULADOS)
    # ══════════════════════════════════════════════════════════════════════════

    def base_values_export_excel(self):
        """
        Exporta los valores base acumulados para cálculo de prestaciones.
        Genera un Excel con hojas para cada tipo de prestación según la estructura.
        """
        query_vacaciones = ''
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # EXPORTACION EXCEL LINEAS DE NOMINA
    # ══════════════════════════════════════════════════════════════════════════

    def get_excel_lines(self):
        """
        Exporta las líneas del recibo de nómina a Excel.
        Incluye todas las líneas con sus detalles.
        """
        # Generar EXCEL
