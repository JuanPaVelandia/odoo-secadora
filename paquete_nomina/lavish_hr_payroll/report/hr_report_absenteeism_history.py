...
class HrReportAbsenteeismHistory(models.TransientModel):
    ...
    def get_info_absenteeism(self):
        ...
        if self.state:
            obj_absenteeism = obj_absenteeism.filtered(lambda x: x.employee_id.contract_id.state in ['open', 'finished'])
