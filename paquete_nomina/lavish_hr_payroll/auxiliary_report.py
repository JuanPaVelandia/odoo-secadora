...
class AccountAuxiliaryReportFilters(models.TransientModel):
    ...
    def _compute_display_name(self):
        for record in self:
            ...
            type_auxiliary_txt = dict(record._fields['type_auxiliary'].selection).get(record.type_auxiliary)
            record.display_name = f'Auxiliar {period_txt.lower()} {type_auxiliary_txt}'
