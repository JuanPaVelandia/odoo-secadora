...
class HrVoucherSendingFailed(models.Model):
...
class PayslipVoucherSending(models.Model):
    ...
    def _create_pdf_attachment(self, env, payslip, pdf_content: bytes):
    ...
    def _process_payslip(self, env, payslip_id: int):
        ...
        try:
            ...
            pdf_content, dummy = env['ir.actions.report']._render_qweb_pdf(report, payslip.id)
    ...
    def _process_batch(self, payslip_ids: List[int]):
