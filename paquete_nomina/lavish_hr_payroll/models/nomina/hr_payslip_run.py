...
class HrPayslipRun(models.Model):
    ...
    @api.depends('slip_ids', 'slip_ids.employee_id', 'slip_ids.employee_id.contract_id', 'slip_ids.employee_id.contract_id.change_wage_ids')
    def _compute_batch_change_wage_ids(self):
        for run in self:
            contracts = run.slip_ids.mapped('employee_id.contract_id')
