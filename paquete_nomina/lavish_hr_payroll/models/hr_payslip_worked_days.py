...
class HrPayslipWorkedDays(models.Model):
    ...
    # v19: hr.contract fue parcialmente reemplazado por hr.version y este modelo
    # ahora expone version_id en vez de contract_id. Mantenemos contract_id como
    # bridge para compatibilidad con la lógica heredada de v18 (get_worked_day_lines,
    # SQL queries, reportes, etc.) que sigue usando contract_id.
    contract_id = fields.Many2one(
        'hr.contract',
        string='Contrato',
        index=True,
        help='Contrato asociado a la línea de días trabajados para compatibilidad con modelos legacy.'
    )
