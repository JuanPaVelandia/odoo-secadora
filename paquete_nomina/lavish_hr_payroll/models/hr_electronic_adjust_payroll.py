...
class HrElectronicAdjustPayrollDetail(models.Model):
    ...
    def consume_web_service_get_cune(self):
        try:
            ...
            _logger.warning('Empleado %s Error: %s' % (self.employee_id.name, str(e)))
...
class HrElectronicAdjustPayroll(models.Model):
    ...
    def unlink(self):
        ...
        return super(HrElectronicAdjustPayroll, self).unlink()
