...
class HrPeriod(models.Model):
    ...
    _date_period_company_uniq = models.Constraint('unique(date_start, date_end, type_period, type_biweekly, company_id)', 'No puede existir un periodo duplicado para la misma compañía')
