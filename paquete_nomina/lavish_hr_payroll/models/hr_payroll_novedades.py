...
class HrPayrollNovedades(models.Model):
    ...
    total = fields.Float("Total", compute='_compute_price', digits='Product Price', store=True)
...
class HrPayrollNovedadesCategory(models.Model):
    ...
    _name_uniq = models.Constraint('unique(name)', 'El Nombre tiene que ser unico!')
    _code_uniq = models.Constraint('unique(code)', 'El Codgigo tiene que ser unico!')
