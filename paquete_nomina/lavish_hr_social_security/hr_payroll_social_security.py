            ...
            for o_employee in obj_employee:
                ...
                #Obtener contratos
                    ...
                    for obj_contract in obj_contracts:
                        ...
                        # Ley 2466/2025: Aprendices con seguridad social completa
                        bAprendizConSSCompleta = bEsAprendiz and getattr(annual_parameters, 'apprentice_full_social_security', False)
                        nDiasLiquidados = 0
                        ...
                        if cant_payslip > 0:
                            ...
                            result = {
                                ...
                                #SENA & ICBF
                                # Ley 2466/2025: Aprendices con SS completa no se benefician de exoneración
                                'cExonerado1607': employee.company_id.exonerated_law_1607 if (bEsAprendiz == False or bAprendizConSSCompleta) and nSueldo < (annual_parameters.smmlv_monthly*10) else False,
                            ...
                            for executing in sorted(obj_executing,key=lambda x: (x.nDiasLiquidados,x.nDiasIncapacidadEPS,x.nDiasVacaciones,x.nDiasMaternidad,x.nDiasIncapacidadARP,x.nDiasLicenciaRenumerada,x.nDiasLicencia)):
                                ...
                                if obj_parameterization_contributors.liquidated_eps_employee or obj_parameterization_contributors.liquidates_eps_company:
                                    ...
                                    if nValorBaseSalud > 0:
                                        # Ley 2466: Si aprendiz con SS completa, aporta como empleado regular
                                        if bEsAprendiz == False or bAprendizConSSCompleta:
                                        ...
                                        # Ley 2466: Aprendiz con SS completa usa tasa normal de empresa
                                        if not employee.company_id.exonerated_law_1607 or (employee.company_id.exonerated_law_1607 and nSueldo >= (annual_parameters.smmlv_monthly*10)) or (bEsAprendiz == True and not bAprendizConSSCompleta):
                                            nPorcAporteSaludEmpresa = annual_parameters.value_porc_health_company if (not bEsAprendiz or bAprendizConSSCompleta) else annual_parameters.value_porc_health_employee+annual_parameters.value_porc_health_company
                                    ...
                                    nValorBaseSalud = 0
                                #----------------CALCULOS PENSION
                                # Ley 2466/2025: Aprendices con SS completa aportan a pensión
                                if (bEsAprendiz == False or bAprendizConSSCompleta) and employee.subtipo_coti_id.not_contribute_pension == False and (obj_parameterization_contributors.liquidate_employee_pension or obj_parameterization_contributors.liquidated_company_pension or obj_parameterization_contributors.liquidates_solidarity_fund):
                                ...
                                # Ley 2466/2025: Aprendices con SS completa aportan a Caja
                                if (bEsAprendiz == False or bAprendizConSSCompleta) and obj_parameterization_contributors.liquidated_compensation_fund:
                                    ...
                                    nValorBaseCajaCom = 0
                                #----------------CALCULOS SENA & ICBF
                                # Ley 2466/2025: Aprendices con SS completa aportan a SENA/ICBF
                                if (bEsAprendiz == False or bAprendizConSSCompleta) and obj_parameterization_contributors.liquidated_sena and obj_parameterization_contributors.liquidated_icbf:
                                    if nValorBaseSENA == 0:
