...
class HrEntitiesReports(models.TransientModel):
    ...
    def generate_entities_excel(self):
        ...
        query_report = f'''
                        select * from
                        (
                            select a."name" as empleado,rc."name" as compania,b.date_change as fecha_ingreso,'' as sucursal,aaa."name" as cuenta_analitica,c."name" as tipo_entidad,e."name" as entidad,
