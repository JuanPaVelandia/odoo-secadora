...
class hr_employeePublic(models.Model):
    ...
    #Seguridad social - asignación
    branch_social_security_id = fields.Many2one('hr.social.security.branches', 'Sucursal seguridad social')
    work_center_social_security_id = fields.Many2one('hr.social.security.work.center', 'Centro de trabajo seguridad social')